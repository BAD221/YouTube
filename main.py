...
@IIIIIIGII.on_message(filters.command("start"))
async def start(client, message):
   if message.chat.type == 'private':
       await IIIIIIGII.send_message(
...
• BY : @IIIIIIGII
                            ...
                            reply_markup=InlineKeyboardMarkup(
                                ...
                                [
                                        ...
                                        InlineKeyboardButton('• DEV', url='https://T.ME/IIIIIIGII')
                                    ],]
                            ),        
            disable_web_page_preview=True,        
            parse_mode="html")

@IIIIIIGII.on_message(filters.command("help"))
...
@IIIIIIGII.on_message(filters.command("about"))
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="▾∮ تم حظرك من استخدام البوت تواصل مع مطوري [اضغط هنا](https://t.me/IIIIIIGII).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await c.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("قناة السورس", url=f"https://t.me/TWIX_CH")
                        ]
                    ]
                ),
                parse_mode="markdown"
            ...
            await c.send_message(
                chat_id=message.chat.id,
                text="هنالك شي خطا تواصل مع مطوري [اضغط هنة](https://t.me/IIIIIIGII).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
@IIIIIIGII.on_callback_query(filters.regex("^ytdl_audio$"))
...
@IIIIIIGII.on_callback_query(filters.regex("^ytdl_video$"))
